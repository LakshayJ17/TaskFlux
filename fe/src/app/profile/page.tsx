...
export default function ProfilePage() {
    ...
    if (!user) return null;
    return (
        <div className="animate-fade-in delay-400 bg-gray-200/10">
            <Header />
            <div className="flex gap-8 m-8">
                ...
                <div className="basis-3/4 flex flex-col space-y-7">
                    <div className="flex basis-1/5 gap-5">
                        <div className="basis-1/3 bg-white rounded-xl border shadow flex justify-around items-center ">
                            <div className="border rounded-3xl text-white bg-purple-500 p-6"><GitFork /></div>
                            <div>
                                <div className="text-xl font-bold">100</div>
                                <div className="text-lg font-semibold text-gray-500">Workflows Created</div>
                            </div>
                        </div>
                        <div className="basis-1/3 bg-white rounded-xl border shadow flex justify-around items-center ">
                            <div className="border rounded-3xl text-white bg-purple-500 p-6"><IconLink /></div>
                            <div>
                                <div className="text-xl font-bold">10</div>
                                <div className="text-lg font-semibold text-gray-500">Total Integrations</div>
                            </div>
                        </div>
                        <div className="basis-1/3 bg-white rounded-xl border shadow flex justify-around items-center ">
                            <div className="border rounded-3xl text-white bg-purple-500 p-6"><Play /></div>
                            <div>
                                <div className="text-xl font-bold">10</div>
                                <div className="text-lg font-semibold text-gray-500">Active Workflows</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="basis-4/5 border rounded-xl shadow bg-white">
                        <div className="flex justify-between px-10 py-5 border-b bg-gray-300/20 rounded-t-xl">
                            <div className="font-semibold text-2xl">
                                Connected Integrations
                            </div>

                            <Button className="flex bg-gradient-to-r from-emerald-800 to-emerald-400 hover:from-emerald-900 hover:to-emerald-600 w-4xs cursor-pointer py-5">
                                <Plus />
                                Add Integration
                            </Button>
                        </div>
                        <div className="grid grid-cols-3 gap-4 p-6">
                            {items.map((item: Integration) => (
                                <div
                                    key={item.id}
                                    className={`
                                            rounded-xl p-6 flex flex-col gap-3 border shadow
