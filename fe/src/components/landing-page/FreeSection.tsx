...
export default function FreeSection() {
  return (
    <section className="py-20 px-6 bg-gradient-to-r from-emerald-500 via-green-500 to-violet-500 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 right-1/3 w-24 h-24 bg-white/10 rounded-full animate-float-delayed"></div>
      </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-12 opacity-90 max-w-4xl mx-auto animate-fade-in delay-200">
